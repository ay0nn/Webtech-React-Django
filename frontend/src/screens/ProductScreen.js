...
function ProductScreen() {
  ...
  return (
    ...
    <Col md={3}>
        ...
        <ListGroup.Item>
            <Button onClick = {addToCartHandler} className='btn btn-success' disabled={product.countInStock === 0} type='button'>Add to cart</Button>
        </ListGroup.Item>
            ...
            <ListGroup.Item>
                ...
                {userInfo ?(
                    <Form onSubmit={submitHandler}>
                        ...
                        <Button disabled={loadingPR} type='submit' vairant='primary'>Submit</Button>
